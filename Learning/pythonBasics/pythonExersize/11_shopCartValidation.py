...
#             if self.ItemsInCart + items_to_add > self.CartLimit:
#                 raise Exception("Cart limit exceeded.")
#             # else:
#             #     return print(f"{items_to_add} items added. Total in cart: {ItemsInCart}")
#             self.ItemsInCart += items_to_add
#             # return self.ItemsInCart
#             return print(f"{items_to_add} items added. Total in cart: {self.ItemsInCart}")
#         except Exception as e:
#             print(e)
#
#
# shopobj = Shop()
# shopobj.add_to_cart(2)
# shopobj.add_to_cart(-1)
